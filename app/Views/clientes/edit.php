...
<div class="container">
    ...
    <form action="<?= site_url('/clientes/update/' . $cliente['cliente_id']); ?>" method="post">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="historial_compras" name="historial_compras" value="<?= $cliente['historial_compras']; ?>" required>
        </div>
